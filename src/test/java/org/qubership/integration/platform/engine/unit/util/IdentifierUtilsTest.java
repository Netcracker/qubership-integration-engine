...
//    }
    ...
    @Test
    void should_build_ElementIdentifier_when_three_parts_provided() {
    ...
    @Test
    void should_build_ElementIdentifier_with_externalId_when_four_parts_provided() {
    ...
    @Test
    void should_throw_when_identifier_is_null_or_has_less_than_three_parts() {
        ...
        IllegalArgumentException e2 = assertThrows(IllegalArgumentException.class,
                () -> IdentifierUtils.spreadIdentifier("a:b")); // только 2 части
...
//
//        assertFalse(IdentifierUtils.isServiceElement("SESSION_WRAPPER:camel:name")); // не точное совпадение
...
//    }
    ...
    @Test
    void should_validate_lowercase_uuid_v4_like_format() {
        String u = "123e4567-e89b-12d3-a456-426614174000";
        assertTrue(IdentifierUtils.isValidUUID(u));
    }

    @Test
    void should_reject_uppercase_or_malformed_uuid() {
        assertFalse(IdentifierUtils.isValidUUID("123E4567-E89B-12D3-A456-426614174000")); // верхний регистр
        assertFalse(IdentifierUtils.isValidUUID("not-a-uuid"));
        assertFalse(IdentifierUtils.isValidUUID("123e4567-e89b-12d3-a456-42661417400"));  // мало цифр
    }

    @Test
    void should_build_retry_iterator_property_name_from_element_id() {
        assertEquals("internalProperty_serviceCall_XYZ_Iterator",
                IdentifierUtils.getServiceCallRetryIteratorPropertyName("XYZ"));
    }

    @Test
    void should_build_retry_property_name_from_element_id() {
